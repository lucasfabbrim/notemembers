            ...
            <div className="p-6 md:p-8 space-y-6">
              ...
              <div className="flex items-center gap-4 pt-4 border-t border-zinc-800">
                <div className="w-12 h-12 rounded-full bg-purple-500/10 flex items-center justify-center flex-shrink-0">
                  <Icon icon="solar:user-bold" className="w-6 h-6 text-purple-500" />
                </div>
                <div>
                  <p className="text-white font-medium">Lucas Mendes</p>
                  <p className="text-zinc-400 text-sm">Especialista em Produtividade</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4">
                <div className="flex items-center gap-3 text-sm">
                  <div className="w-10 h-10 rounded-full bg-zinc-800 flex items-center justify-center">
                    <Icon icon="solar:clock-circle-bold" className="w-5 h-5 text-purple-500" />
                  </div>
                  <div>
                    <p className="text-zinc-400 text-xs">Duração</p>
                    <p className="text-white font-medium">12:45</p>
                  </div>
                </div>

                <div className="flex items-center gap-3 text-sm">
                  <div className="w-10 h-10 rounded-full bg-zinc-800 flex items-center justify-center">
                    <Icon icon="solar:eye-bold" className="w-5 h-5 text-purple-500" />
                  </div>
                  <div>
                ...
                <div className="flex items-center gap-3 text-sm">
                  ...
                  <div>
                    ...
                    <p className="text-white font-medium">Há 2 dias</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-6">
                <Button asChild className="bg-purple-600 hover:bg-purple-700 text-white transition-colors flex-1">
                  <a
                ...
                <Button
                  variant="outline"
                  className="border-zinc-700 hover:bg-zinc-800 text-white transition-colors bg-transparent"
                >
                  ...
                  {[
                    ...
                    <li key={index} className="flex items-start gap-3 text-zinc-300 text-sm">
                      <div className="w-5 h-5 rounded-full bg-purple-500/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                        <Icon icon="solar:check-circle-bold" className="w-4 h-4 text-purple-500" />
                      </div>
                      {item}
                    </li>
                  ))}
